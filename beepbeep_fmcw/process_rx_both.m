...
%% 1. gsize: the number of FMCW chirps to process each time
%% 2. gt_fmcw_peak_idx: the distance between FMCW and PN singals
%% **************************
%%
%% example:
%%   process_rx_both('rx1', 1, 'avg')
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [avg_errs, std_errs] = process_rx_both(filename, config, combine_method)
