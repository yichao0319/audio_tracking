...
if not is_win32:
    if 0:
        ...
        exe_dir    = "/u/yichao/bin/libsvm-3.17/"
        svmscale_exe = exe_dir + "svm-scale"
        svmtrain_exe = exe_dir + "svm-train"
        svmpredict_exe = exe_dir + "svm-predict"
        grid_py = exe_dir + "tools/grid.py"
        gnuplot_exe = "/usr/bin/gnuplot"
